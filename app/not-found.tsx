  ...
  return (
    <PermissionsProvider>
      <div className="flex flex-col w-screen h-screen justify-center items-center space-y-10">
        ...
        <Link href="/" className="group inline-flex items-center animate-in slide-in-from-bottom-5 duration-1400 fade-in  overflow-hidden rounded-md cursor-pointer hover:bg-primary/20 pr-2 ">
